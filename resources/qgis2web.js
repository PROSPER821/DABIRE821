...
map.getView().fit([-561803.860450, 1206852.549626, -20073.667041, 1489643.332225], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CARTE DESCRIPTIVE DE LA DENSITE DE LA REGION DE NANDO</h2>';
        return titleElement;
    })(),
